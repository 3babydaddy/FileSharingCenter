...
//		strategy.setTablePrefix(new String[] { "bmd_", "mp_" });// 此处可以修改为您的表前缀
		...
		strategy.setInclude(new String[] { "share_disk_info" }); // 需要生成的表
		...
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.tf.commons.base.BaseController");
